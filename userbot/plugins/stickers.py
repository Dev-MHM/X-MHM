...
async def _(event):
    ...
    if userid == 906582956:
        packname = f"@CyberProgram Packs 🎭"
        packshortname = "CyberProgramPack"
    else:
    ...
    file_ext_ns_ion = "@MHMOFFICIAL.png"
    ...
    if is_a_s:
        ...
        if userid == 906582956:
            packname = f"CyberProgram Ka Pack"
            packshortname = "CyberProgramisgreat"
        else:
            packname = f"{user.username}'s {pack}"
